...
def can_parse_segment(line):
    return re.match(__SEG_RE, line)

def parse_segment(line):
    match = re.match(__SEG_RE, line)
    return Segment(
        start = Point(
